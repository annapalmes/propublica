...
// la suma de los miembros de cada partido y la media de los votos de cada partido:
...
function smallestvalue1() {
    ...
    for (var i = 0; i < memberscopy.length; i++) { // aqui hago un for del memberscopy.length porque es la copia y le hago el 10% de esta manera mutiplicandolo por 0,1 (manera simplificada).
        // como hemos dicho antes ahora le haremos el push para meterlo en la array creada antes.
...
function senateglance1() {
    ...
    var tbody = document.getElementById("senate");
...
function leastTable1() {
    ...
    var tBody = document.getElementById("most");
    ...
    for (var a = 0; a < statisticsobject.leastVotes.length; a++) {
        ...
        var numbervotes = statisticsobject.leastVotes[a].missed_votes;
        var missedpct = statisticsobject.leastVotes[a].missed_votes_pct + " %";

        var firstcell = (name + " " + middlename + " " + secondname);
...
function mostTable1() {
    ...
    var tBody = document.getElementById("least");
    ...
    for (var a = 0; a < statisticsobject.mostVotes.length; a++) {
        ...
        var numbervotes = statisticsobject.mostVotes[a].missed_votes;
        var missedpct = statisticsobject.mostVotes[a].missed_votes_pct + " %";
...
function senateglance() {
    ...
    var tbody = document.getElementById("senate1");
...
function leastTable() {
    ...
    var tBody = document.getElementById("most2");
...
function mostTable() {
    ...
    var tBody = document.getElementById("least1");
